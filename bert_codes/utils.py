...
# def save_model_SAI(model,tokenizer,params):
#     if(params['to_save']==True):   
...
#             output_dir = 'GermanTranslateTesting/'+params['path_files']+'_'+params['language']+'_'+translate+'_'+params['how_train']+'_'+str(params['sample_ratio'])
#         else:
#             output_dir = 'GermanTranslateTesting/'+params['path_files']+'_'+translate+'_'+params['how_train']+'_'+str(params['sample_ratio'])
